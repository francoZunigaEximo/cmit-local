...
class AuditoriaMailFacturacionMigracion implements ProcesadorInterface
{
    public function insertar(array $data)
    {
        $auditoriaEmail = AuditoriaMailFacturacion::firstOrCreate('Id', $data['Id']);
    ...
    {
        AuditoriaMailFacturacion::where('Id', $before['Id'])->delete();
        Log::info("Auditoria Mail Facturacion {$before['Id']} eliminado.");
    }
