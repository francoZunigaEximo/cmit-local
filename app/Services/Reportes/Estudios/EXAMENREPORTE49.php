...
include('variables.php');
        ...
        $pdf->SetXY(137,84);if($cuil!=''){$pdf->Cell(0,3,$cuil,0,0,'L');}else{$pdf->Cell(0,3,$doc,0,0,'L');}
        ...
        $pdf->SetXY(30,100);$pdf->Cell(0,3,$locpac,0,0,'L');$pdf->SetXY(106,100);$pdf->Cell(0,3,$cp,0,0,'L');$pdf->SetXY(135,100);$pdf->Cell(0,3,$telpac,0,0,'L');
