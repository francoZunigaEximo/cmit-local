...
if($vistaPrevia){
    ...
    $edad = Carbon::parse($prestacion->paciente->FechaNacimiento)->age;
    ...
    $codigoArea = data_get($telefonoPaciente, 'CodigoArea', 'S/N');
    $numeroTelefono = data_get($telefonoPaciente, 'NumeroTelefono', 'S/N');
    $telpac = "(".$codigoArea.") ".$numeroTelefono;
