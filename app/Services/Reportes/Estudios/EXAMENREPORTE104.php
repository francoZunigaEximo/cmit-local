...
class EXAMENREPORTE104 extends Reporte
{
...
include('variables.php');
        ...
        //cuerpo
        $pdf->SetFont('Arial','B',11);$pdf->Cell(0,4,"CONSENTIMIENTO INFORMADO PARA EL TESTEO DE 6 DROGAS",0,0,'C');$pdf->Ln(10);
        ...
        //cuadro resultados
        $y=$pdf->GetY();//180
        $pdf->Rect(30,$y,100,42);$pdf->Line(90,$y,90,$y+42);$pdf->Line(110,$y,110,$y+42);
        $pdf->Line(30,$y+6,130,$y+6);$pdf->Line(30,$y+12,130,$y+12);$pdf->Line(30,$y+18,130,$y+18);
        $pdf->Line(30,$y+24,130,$y+24);$pdf->Line(30,$y+30,130,$y+30);$pdf->Line(30,$y+36,130,$y+36);
        ...
        $pdf->SetXY(33,$y+20);$pdf->Cell(0,3,'Benzodiacepina',0,0,'L');
        $pdf->SetXY(33,$y+26);$pdf->Cell(0,3,'Barbituricos',0,0,'L');
        $pdf->SetXY(33,$y+32);$pdf->Cell(0,3,'Morfina',0,0,'L');
        $pdf->SetXY(33,$y+38);$pdf->Cell(0,3,'Anfetaminas',0,0,'L');
        //fin
        $y=$pdf->GetY();$pdf->SetY($y+6);$y=$pdf->GetY();$pdf->SetFont('Arial','',11);
