...
class EXAMENREPORTE75 extends Reporte
{
    public function render(FPDF $pdf, $datos = ['id', 'idExamen']): void
    {
        include('variables.php');
       
        $pdf->Image(public_path("/archivos/reportes/E75_1.jpg"),12,15,190); 
        $pdf->Image(public_path("/archivos/reportes/E75_2.jpg"),12,147,190); 
        ...
        $pdf->SetXY(93,94);$pdf->Cell(0,3,$nac,0,0,'L');
        ...
        $pdf->SetXY(34,101);$pdf->Cell(0,3,$locpac,0,0,'L');$pdf->SetXY(106,101);$pdf->Cell(0,3,$cp,0,0,'L');$pdf->SetXY(135,101);$pdf->Cell(0,3,$telpac,0,0,'L');
        $pdf->SetXY(49,105);$pdf->Cell(0,3,$puesto,0,0,'L');$pdf->SetXY(174,105);$pdf->Cell(0,3,$antigpto,0,0,'L');
    }
