...
class EXAMENREPORTE18 extends Reporte
{
    ...
    {   
        ...
        $pdf->SetXY(56,36);$pdf->Cell(0,3,$fechanac,0,0,'L');$pdf->SetXY(125,36);$pdf->Cell(0,3,$cuil,0,0,'L');
        $pdf->SetXY(38,40);$pdf->Cell(0,3,substr($lugarnac,0,20),0,0,'L');$pdf->SetXY(125,40);$pdf->Cell(0,3,$fecha,0,0,'L');
        $pdf->SetXY(45,45);$pdf->Cell(0,3,$ec,0,0,'L');$pdf->SetXY(130,45);$pdf->Cell(0,3,$nac,0,0,'L');
        $pdf->SetXY(50,49);$pdf->Cell(0,3,$doc,0,0,'L');$pdf->SetXY(140,49);$pdf->Cell(0,3,$hijos,0,0,'L');
        $pdf->SetXY(135,53);$pdf->Cell(0,3,$puesto,0,0,'L');
        $pdf->SetFont('Arial','',7);
        $pdf->SetXY(26,61);$pdf->Cell(0,3,$domipac,0,0,'L');$pdf->SetXY(105,61);$pdf->Cell(0,3,$locpac,0,0,'L');
        $pdf->SetXY(140,61);$pdf->Cell(0,3,$cp,0,0,'L');$pdf->SetXY(148,61);$pdf->Cell(0,3,$telpac,0,0,'L');
    }
