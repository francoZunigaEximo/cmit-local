...
class CaratulaInterna extends Reporte
{
    public function render(FPDF $pdf, $datos = ['id']): void
    {
        ...
        $pdf->SetXY(38,$y);$pdf->Cell(0,3,utf8_decode(substr($paciente,0,40)),0,0,'L');$y=$y+8;
        ...
        $pdf->SetXY(38,$y);$pdf->Cell(0,3,utf8_decode(substr($prestacion->empresa->RazonSocial,0,40)),0,0,'L');$y=$y+8;
        $pdf->SetXY(11,$y);$pdf->Cell(0,3,'Empresa:',0,0,'L');
        $pdf->SetXY(38,$y);$pdf->Cell(0,3,  utf8_decode(substr($prestacion->empresa->ParaEmpresa,0,40)),0,0,'L');$y=$y+8;
