...
class EEstudio extends Reporte
{
    public function render(FPDF $pdf, $datos = ['id']): void
    {
        ...
        $pdf->SetXY(109,$y);$pdf->Cell(0,3,utf8_decode($prestacion->paciente->TipoDocumento.' '.$prestacion->paciente->Documento),0,0,'L');$y=$y+10;
        $pdf->SetXY(109,$y);$pdf->Cell(0,3,utf8_decode(substr($prestacion->empresa->RazonSocial,0,28)),0,0,'L');$y=$y+10;
        $pdf->SetXY(109,$y);$pdf->Cell(0,3,utf8_decode(substr($prestacion->empresa->ParaEmpresa,0,28)),0,0,'L');$y=$y+10;
