                            ...
                            registros.forEach(function(examen) {
                                ...
                                let fila = `
                                        <tr ${examen.Anulado === 1 ? 'class="filaBaja"' : ''}>
                                            ...
                                            <td class="date text-center" title="${examen.Informe === 0 ? examen.ApellidoI : ''} ${examen.Informe === 1 ? examen.NombreI : ''}">${examen.Informe === 1 ? examen.ApellidoI : ''}${examen.Informe} ${examen.Nombre}
