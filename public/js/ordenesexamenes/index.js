$(function () {
    ...
    $(document).on('click', '#resetPres', function (e) {
        ...
        $('#fechaDesdePres').val(fechaNow(null, "-", 0));
    });

    $(document).on('click', '#resetResumenes', function (e) {
        e.preventDefault();
        $('#especialidadResumenes, #efectoresResumenes, #efectorResumenes, #profEfectorResumenes').val('');
        $('#listaOrdenesResumenes').DataTable().clear().destroy();
        $('#fechaDesdeResumenes').val(fechaNow(null, "-", 0));
    });
