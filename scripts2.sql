...
DELETE FROM localidades WHERE Nombre = 'CONTRARAMIORANTE CORDERO';
DELETE FROM localidades WHERE Nombre = 'GRAL FERNANDEZ ORO';

--Rio Negro
INSERT INTO localidades (Nombre, CP, IdPcia) VALUES
('6 DE OCTUBRE', 8134, 2),
('AGUADA CECILIO', 8534, 2),
('AGUADA DE GUERRA', 8424, 2),
('AGUADA DE LOS PAJARITOS', 8301, 2),
('AGUADA DE PIEDRA', 8422, 2),
('AGUADA DEL LORO', 8520, 2),
('AGUADA GUZMAN', 8333, 2),
('AGUARA', 8307, 2),
('ALANITOS', 8333, 2),
('ANECON CHICO', 8418, 2),
('ANECON GRANDE', 8416, 2),
('ARROYO BLANCO', 8403, 2),
('ARROYO CHACAY', 8401, 2),
('ARROYO DE LA VENTANA', 8521, 2),
('ARROYO LAS MINAS', 8415, 2),
('ARROYO LOS BERROS', 8521, 2),
('ARROYO SALADO', 8532, 2),
('ARROYO TEMBRADO', 8521, 2),
('ARROYO VERDE', 8521, 2),
('ATRAICO', 8418, 2),
('BAJO DEL GUALICHO', 8520, 2),
('BAJO RICO', 8360, 2),
('BALNEARIO EL CONDOR', 8501, 2),
('BALNEARIO LAS GRUTAS', 8521, 2),
('BARDA COLORADA', 8333, 2),
('BARDA DEL MEDIO', 8305, 2),
('BARRIL NIYEO', 8422, 2),
('BARRIO NORTE', 8328, 2),
('BENJAMIN ZORRILLA', 8360, 2),
('BOCA DE LA TRAVESIA'. 8505, 2),
('CA', 8416, 2),
('CA', 8417, 2),
('CA', 8412, 2),
('CALTRAUNA', 8424, 2),
('CAMPANA MAHUIDA', 8532, 2),
('CANLLEQUIN', 8417, 2),
('CARHUE', 8412, 2),
('CARRI YEGUA', 8417, 2),
('CARRILAUQUEN', 8418, 2),
('CASA QUEMADA', 8412, 2),
('CASCADA LOS CANTAROS', 8411, 2),
('CERRO ABANICO', 8424, 2),
('CERRO ALTO', 8403, 2),
('CERRO MESA', 8415, 2),
('CERRO POLICIA', 8333, 2),
('CHACALHUA RUCA', 8415, 2),
('CHACAY HUARRUCA', 8415, 2),
('CHAIFUL', 8418, 2),
('CHASICO', 8417, 2),
('CHELFORO', 8366, 2),
('CHENQUENIYEU', 8412, 2),
...
('CINCO SALTOS', 8303, 2),
('CIPOLLETTI', 8324, 2),
('CLEMENTE ONELLI', 8416, 2),
('COLI TORO', 8418, 2),
('COLONIA ALTE GUERRICO', 8307, 2),
('COLONIA EL MANZANO', 8305, 2),
('COLONIA GENERAL FRIAS', 8501, 2),
('COLONIA JOSEFA', 8363, 2),
('COLONIA LA LUISA', 8503, 2),
('COLONIA REGINA', 8336, 2),
('COLONIA RUSA', 8332, 2),
('COLONIA SAN JUAN', 8503, 2),
('COMALLO', 8416, 2),
('COMALLO ABAJO', 8416, 2),
('COMI CO', 8424, 2),
('CONA NIYEU', 8521, 2),	
('CONTRALMIRANTE M GUERRICO', 8328, 2),
('COQUELEN', 8416, 2),
('CORONEL BELISLE', 8364, 2),
('CORONEL EUGENIO DEL BUSTO', 8138, 2),
('CORONEL FRANCISCO SOSA', 8503, 2),
('CORONEL JUAN JOSE GOMEZ', 8333, 2),
('CORONEL VIDAL', 8305, 2),
('CORRAL DE LOS PINOS', 8412, 2),
('CORRALITO', 8403, 2),
('COS ZAURES', 8307, 2),
('COSTA DEL RIO AZUL', 8430, 2),
('COSTAS DEL PICHI LEUFU', 8412, 2),
('CUATRO ESQUINAS', 8324, 2),
('CUENCA VIDAL', 8301, 2),
('CURA LAUQUEN', 8417, 2),
('DINA HUAPI', 8402, 2),
('EL CACIQUE', 8417, 2),
...
('EL CAMARURO', 8417, 2),
('EL CHEIFUL', 8418, 2),
('EL CONDOR ESTANCIA', 8400, 2),
('EL DIQUE', 8500, 2),
('EL FOYEL', 8401, 2),
('EL GAUCHO POBRE', 8417, 2),
('EL JARDINERO', 8417, 2),
('EL MANSO', 8430, 2),
('EL MANZANO', 8328, 2),
('EL MOLIGUE', 8418, 2),
...
('EL PORVENIR', 8503, 2),
('EL SALADO', 8536, 2),
('EMPALME KILOMETRO 648', 8418, 2),
('ESTANCIA LAS JULIAS', 8363, 2),
('FALCKNER', 8534, 2),
('FERRI', 8301, 2),
('FITA RUIN', 8418, 2),
('FITALANCAO', 8415, 2),
...
('FITATIMEN', 8415, 2),
('FORTIN UNO', 8360, 2),
('GANZU LAUQUEN', 8424, 2),
('GENERAL LIBORIO BERNAL', 8500, 2),
('GUARDIA MITRE', 8505, 2),
