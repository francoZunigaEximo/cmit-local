...
<head>
    ...
    <title>Error 500 - Salud Ocupacional SRL</title>
...
<body>
    <div class="row">
        ...
        <div class="col-sm-12 center">
            <h3 class="subtitulo-error">Error interno en el servidor</h3>
        </div>
        <div class="col-sm-12 center">
            <p class="mensaje-error">Nos encontramos experimentando inconvenientes técnicos.</p>
        </div>
        <div class="col-sm-12 center">
