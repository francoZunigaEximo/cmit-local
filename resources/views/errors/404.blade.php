...
<body>
    <div class="row">
        ...
        <div class="col-sm-12 center">
            <h3 class="subtitulo-error">Página no encontrada</h3>
        </div>
        <div class="col-sm-12 center">
            <p class="mensaje-error">La página a la que quiere acceder ha sido borrada o ha escrito mal su dirección</p>
        </div>
        <div class="col-sm-12 center">
