                ...
                <div class="col-4 box-information">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <select class="form-select" name="Nacionalidad" id="Nacionalidad">
                            <option value="{{ $paciente->Nacionalidad ?? '' }}" selected>{{ $paciente->Nacionalidad ?? 'Elija el país...' }}</option>
                    ...
                    <div class="input-group input-group-sm mb-3 ciudad">
                        ...
                        <input type="text" class="form-control" id="ciudad" name="ciudad" value="{{ $paciente->ciudad ?? ''}}">
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3 provincia2">
                        ...
                        <input type="text" class="form-control" id="provincia2" name="provincia2" value="{{ $paciente->provincia2 ?? ''}}">
                    </div>
