...
const saveRemitos = "{{ route('mapas.guardarRemito') }}";
const updateMapa = "{{ route('mapas.actualizar') }}";
const searchMapaPres = "{{ route('mapas.buscarPrestaciones') }}";
const getPacienteMapa = "{{ route('mapas.getPacientes') }}";
const getExamenMapa = "{{ route('mapas.getExamen') }}";
const serchInCerrar = "{{ route('mapas.buscarCerrados') }}";
const searchInFinalizar = "{{ route('mapas.buscarFinalizados') }}";
const saveEstado = "{{ route('mapas.guardarEstado') }}"
const searchInEnviar = "{{ route('mapas.buscarEnviados') }}";
const saveEnviar = "{{ route('mapas.guardarEnviado') }}";
const saveFinalizar = "{{ route('mapas.guardarFinalizado') }}";
const saveCerrar = "{{ route('mapas.guardarCerrado') }}";
const checkMapa = "{{ route('mapas.chequearMapa') }}";
const getPrestaciones = "{{ route('mapas.getPrestaciones') }}";
const getCerrar = "{{ route('mapas.cerrar') }}";
const getFMapa = "{{ route('mapas.finalizar') }}";
const enviarMapa = "{{ route('mapas.enviar') }}";
const changeEstado = "{{ route('mapas.cambiarEstado') }}";
