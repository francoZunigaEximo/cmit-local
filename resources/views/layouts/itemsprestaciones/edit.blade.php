            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" style="{{ ($data['itemprestacion']->examenes->Adjunto === 1 && !empty($data['adjuntoEfector']) && $data['adjuntoEfector'] === 0 ? 'color: red' : ($data['itemprestacion']->examenes->Adjunto === 1 && !empty($data['adjuntoEfector']) && $data['adjuntoEfector'] === 1 ? 'color: green' : '')) }}" class="form-control" id="Estado" name="Estado" value="{{ ($data['itemprestacion']->examenes->Adjunto === 0 ? 'No lleva Adjuntos' : ($data['itemprestacion']->examenes->Adjunto === 1 && !empty($data['adjuntoEfector']) && $data['adjuntoEfector'] === 0 ? 'Pendiente' : ($data['itemprestacion']->examenes->Adjunto === 1 && !empty($data['adjuntoEfector']) && $data['adjuntoEfector'] === 1 ? 'Adjuntado' : '-'))) }}" @readonly(true)>
