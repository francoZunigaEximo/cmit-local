        ...
        <form id="form-index">
            <div class="col-12 p-3 border border-1 border-color" style="border-color: #666666;">
                <div class="row">
                    ...
                    <div class="col-3 p-1">
                        <label for="aliaspaquete" class="form-label">Especialidad</label>
...
<script>
    ...
    const searchDetalleEstudios = "{{ route('paquetes.searchDetalleEstudios')}}"
    const exportarExcel = "{{route('paquetes.exportDetalleExcel')}}";
</script>
@push('styles')
...
<script src="{{ asset('js/paquetes/detalle_estudios.js') }}?v={{ time() }}"></script>
