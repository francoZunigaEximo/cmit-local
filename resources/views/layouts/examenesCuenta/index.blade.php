            ...
            <div class="tab-pane active" id="exCuenta" role="tabpanel">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="small col-sm-12 mb-2"><span class="required">(*)</span> El campo es obligatorio.
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="listjs-table" id="customerList">
                                    <div class="row g-4 mb-3">
                                        ...
                                        <form id="form-index">
                                            <div class="col-12 p-4 border border-1 border-color"
                                                style="border-color: #666666;">

                                                <div class="row">

                                                    <div class="col-sm-2 mb-3">
                                                        <label for="fechaDesde" class="form-label fw-bolder">Fecha desde:
                                                    ...
                                                    <div class="col-sm-2 mb-3">
                                                        <label for="fechaDesde" class="form-label fw-bolder">Fecha hasta:
                                                            <span class="required">(*)</span></label>
                                                    ...
                                                    <div class="col-sm-2 mb-3">
                                                        <label for="rangoDesde" class="form-label fw-bolder">Factura Desde o
                                                            Individual: </label>
                                                        <input type="text" class="form-control" id="rangoDesde"
                                                            name="rangoDesde">
                                                    </div>

                                                    <div class="col-sm-2 mb-3">
                                                        <label for="rangoDesde" class="form-label fw-bolder">Factura Hasta:
                                                        </label>
                                                        <input type="text" class="form-control" id="rangoHasta"
                                                            name="rangoHasta">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 mb-3">
                                                        <label for="paciente" class="form-label fw-bolder">Paciente /
                                                            DNI:</label>
                                                    ...
                                                    <div class="col-sm-4 mb-3 fechaPago">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <label for="fechaPagoDesde"
                                                                    class="form-label fw-bolder">Fecha Pago Desde: </label>
                                                                <input type="date" class="form-control"
                                                                    id="fechaPagoDesde" name="fechaPagoDesde">
                                                            </div>
                                                            <div class="col-6">
                                                                <label for="fechaPagoHasta"
                                                                    class="form-label fw-bolder">Fecha Pago Hasta: </label>
                                                                <input type="date" class="form-control"
                                                                    id="fechaPagoHasta" name="fechaPagoHasta">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div
                                                        class="col-sm-12 d-flex align-items-center justify-content-end mb-2">
                                                        <button type="button" id="buscar" class="btn botonGeneral"><i
                                                                class="ri-zoom-in-line"></i>&nbsp;Buscar</button>&nbsp;
                                                        <a id="agregar" class="btn botonGeneral"
                                                            href="{{ route('examenesCuenta.create') }}"><i
                                                                class="ri-add-fill"></i>&nbsp;Agregar</a>
                                                    </div>
                                                    <div class="col-sm-12 d-flex align-items-center justify-content-end">
                                                        <button type="button" id="excelSimple"
                                                            class="btn botonGeneral btnExcelSimple"><i
                                                                class="ri-file-excel-2-line"></i>&nbsp;Exportar a
                                                            Excel</button>&nbsp;
                                                        <button type="button" id="excelCompleto"
                                                            class="btn botonGeneral btnExcelCompleto"><i
                                                                class="ri-file-excel-2-line"></i>&nbsp;Exportar a Excel
                                                            Completo</button>&nbsp;
                                    ...
                                    <div class="row">
                                        <div class="col-8 text-start">
                                            ...
                                            <button type="button" class="btn btn-sm botonGeneral facturasHoy"><i
                                                    class="ri-calendar-2-line"></i>&nbsp;Hoy</button>
                                            <button type="button" class="btn btn-sm botonGeneral sieteDias"><i
                                                    class="ri-calendar-2-line"></i>&nbsp;Ultimos 7 días</button>
                                            <button type="button" class="btn btn-sm botonGeneral tresMeses"><i
                                                    class="ri-calendar-2-line"></i>&nbsp;Ultimos 3 meses</button>
                                        </div>

                                        <div class="col-4 text-end">
                                            <button type="button" class="btn btn-sm botonGeneral botonPagar"><i
                                                    class=" ri-money-dollar-circle-line"></i>&nbsp;Pagar masivo</button>
                                            <button type="button" class="btn btn-sm botonGeneral quitarPago"><i
                                                    class=" ri-money-dollar-circle-line"></i>&nbsp;Quitar pago
                                                masivo</button>
                                        </div>
                        ...
                        <div class="col p-2 border border-1 border-color" style="border-color: #666666;">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-3 mb-3">
                                    <label for="empresaSaldo" class="form-label font-weight-bold"><strong>Empresa:
                                        </strong></label>
                                    <select class="form-control" name="empresaSaldo" id="empresaSaldo"></select>
                                </div>

                                <div class="col-sm-3 mb-3">
                                    <label for="examenSaldo" class="form-label font-weight-bold"><strong>Examen:
                                        </strong></label>
                                    <select class="form-control" name="examenSaldo" id="examenSaldo"></select>
                                </div>

                                <div class="col-sm-3 mb-3">
                                    <label for="examenSaldo2" class="form-label font-weight-bold"><strong>Examen 2:
                                        </strong></label>
                                ...
                                <div class="col-sm-3 mb-3 d-flex align-items-end justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-sm botonGeneral" id="buscarSaldo"><i
                                            class="ri-zoom-in-line"></i>&nbsp;Buscar</i></button>
                                </div>
