...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <button type="button" class="btn btnSuccess volverPagoCuenta"><i class="ri-arrow-left-line"></i>&nbsp;Volver</button>
</div>
        ...
        <div class="col p-2 border border-1 border-color" style="border-color: #666666;">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-4 mb-3 text-center">
                    <button type="button" class="btn btnDanger crearPagoCuenta">Registrar</button>
                </div>
            </div>
        </div>
    </form>  
